...
class RecibosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recibo" do
    assert_difference('Recibo.count') do
      post recibos_url, params: { recibo: { combustible_recibo: @recibo.combustible_recibo, folio_recibo: @recibo.folio_recibo, kmactual_recibo: @recibo.kmactual_recibo, kmanterior_recibo: @recibo.kmanterior_recibo } }
    end
  ...
  test "should update recibo" do
    patch recibo_url(@recibo), params: { recibo: { combustible_recibo: @recibo.combustible_recibo, folio_recibo: @recibo.folio_recibo, kmactual_recibo: @recibo.kmactual_recibo, kmanterior_recibo: @recibo.kmanterior_recibo } }
